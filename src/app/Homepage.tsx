      ...
      <div className="w-[90%] sm:w-95% m-auto">
          ...
          <div className="sm:grid sm:grid-cols-4 gap-10">
            <div className="info sm:col-span-3 py-3 sm:mt-5">
              <div className="title">
                <h1 className="text-white font-noto-sans text-2xl sm:text-4xl ">
                  Kawaii Wa Kimi No Mono
                </h1>
                <p className="mt-5 text-white font-medium font-open-sans w-full text-sm sm:text-base sm:w-[80%]">
                  Manga “Kawaii” wa Kimi no mono yang dibuat oleh komikus
                  bernama Iunosu ini bercerita tentang Tamaru, seorang anak
                  laki-laki kecil berwajah bayi, jatuh cinta pada Morinaga,
                  seorang gadis tinggi dan keren. Tamaru-kun berpikir dia tidak
                  cukup baik untuknya, tapi suatu hari dia melihat Morinaga
                  dengan cara yang terlalu tak terduga untuknya…? Komedi cinta
                  yang penuh dengan hal-hal yang tidak dapat Anda ceritakan
                  kepada siapa pun!
                </p>

                <a href="/komik/details/kawaii-wa-kimi-no-mono">
            ...
            <div className="sm:col-span-1 hidden sm:block">
              <div className="images ">
                <Image
                  src="https://cdn.menantuincaran.lol/gbr/2021/09/Komik-The-Cute-One-Is-You.jpg"
                  alt="test"
                  width={150}
                  height={150}
        ...
        <section id="popular" className="sm:mt-10 mt-6">
          ...
          <div id="carousel" className="sm:mt-8 mt-5">
            <Carousel apiPath="/api/mangazuna/manga" />
          </div>
        </section>
        ...
        <section id="trending" className="sm:mt-10 mt-6">
          ...
          <div id="carousel" className="sm:mt-8 mt-5">
            <Carousel apiPath="/api/mangazuna/manhua" />
          </div>
        </section>
        ...
        <section id="manhwa-popular" className="sm:mt-10 mt-6 mb-36">
          ...
          <div id="carousel" className="sm:mt-8 mt-5">
            <Carousel apiPath="/api/mangazuna/manhwa" />
          </div>
        </section>
      </div>
    </>
