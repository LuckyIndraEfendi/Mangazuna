            ...
            <div className="info sm:col-span-3 py-3 sm:mt-5">
              <div className="title">
                ...
                <p className="mt-5 text-white font-medium font-open-sans w-full text-sm sm:text-base sm:w-[80%]">
                  Manga Jujutsu Kaisen yang dibuat oleh komikus bernama AKUTAMI
                  Gege ini bercerita tentang Meskipun Yuji Itadori terlihat
                  seperti remaja pada umumnya, kekuatan fisiknya yang luar biasa
                  patut untuk dilihat! Setiap klub olahraga ingin dia bergabung,
                  tapi Itadori lebih suka bergaul dengan orang-orang buangan
                  sekolah di Klub Penelitian Ilmu Gaib. Suatu hari, klub
                  berhasil mendapatkan benda terkutuk yang tersegel. Mereka
                  tidak tahu teror yang akan mereka keluarkan ketika mereka
                  membuka segelnya
                </p>

                <NavLink href="/komik/details/jujutsu-kaisen">
