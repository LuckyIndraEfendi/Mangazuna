...
const page = async () => {
  const getData = await fetchMangaByAdvSearch("manhua", 1);
  return (
    <>
      <Navbar />
      <div className="w-[90%] m-auto mb-32">
        ...
        <div className="">
          <div className="title mt-5">
            <h1 className="text-white text-2xl sm:text-3xl">Manhua</h1>
          </div>
        </div>
        <div
          className={`contentManhua grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-5 mt-5`}
        >
