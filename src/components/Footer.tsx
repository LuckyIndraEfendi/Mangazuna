...
const Footer: React.FC = () => {
  return (
    <footer className="flex-col w-full mt-20 ">
      <div className="text-[#dbdcdd] z-40 bg-[#0c0d10] dark:bg-[#0c0d10] lg:flex lg:h-[12rem] w-full lg:items-center lg:justify-between">
        <div className="mx-auto flex w-[90%] lg:w-[95%] xl:w-[80%] flex-col space-y-10 py-6 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:py-0">
          <div className="flex flex-col gap-2">
            <div className="flex gap-2 font-outfit text-4xl text-[#FF7A51] dark:text-[#9c9c9c]">
              mangazuna
            </div>
            <p className="font-karla lg:text-[0.8rem] text-[0.65rem]  text-zinc-950 dark:text-[#9c9c9c]  lg:w-[520px] italic">
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:gap-[9.06rem] text-[#a7a7a7] text-sm lg:text-end">
            <div className="flex flex-col gap-10 font-karla font-bold lg:flex-row lg:gap-[5.94rem]">
              <ul className="flex flex-col gap-y-[0.7rem] ">
                <li className="cursor-pointer hover:text-action text-zinc-950 dark:text-white">
                  <NavLink href={`/manga`}>Popular Manga</NavLink>
                </li>
                <li className="cursor-pointer hover:text-action text-zinc-950 dark:text-white">
                  <NavLink href={`/manhwa`}>Popular Manhwa</NavLink>
                </li>
                <li className="cursor-pointer hover:text-action text-zinc-950 dark:text-white">
                  <NavLink href="/">Mangazuna</NavLink>
                </li>
              </ul>
              <ul className="flex flex-col gap-y-[0.7rem]">
                <li className="cursor-pointer hover:text-action text-zinc-950 dark:text-white">
                  <NavLink href={`/dmca`}>DMCA</NavLink>
                </li>
                <li className="cursor-pointer hover:text-action text-zinc-950 dark:text-white">
                  <NavLink href={`https://saweria.co/luckyindraefendi`}>
                    Donate
                  </NavLink>
                </li>
                <li className="cursor-pointer hover:text-action text-zinc-950 dark:text-white">
                  <NavLink href="https://github.com/LuckyIndraEfendi">
                    Github
                  </NavLink>
                </li>
              </ul>
      ...
      <div className="bg-[#0c0d10] border-t border-white/5 dark:bg-[#0c0d10]">
        <div className="mx-auto flex w-[90%] lg:w-[95%] xl:w-[80%] flex-col pb-6 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:py-0">
          <p className="flex items-center gap-1 font-karla lg:text-[0.81rem] text-[0.7rem] text-white dark:text-[#CCCCCC] py-3">
            &copy; {new Date().getFullYear()} mangazuna.xyz | Website Made by{" "}
          ...
          <div className="flex items-center gap-5">
            <NavLink
              href="https://github.com/LuckyIndraEfendi"
            ...
            <NavLink href="/test" className="w-6 h-6 hover:opacity-75">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <NavLink
              href="https://saweria.co/luckyindraefendi"
